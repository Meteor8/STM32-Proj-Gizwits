...
#define P0_VERSION          "00000002"              ///< P0 protocol version
    ...
    * @{
    */
#define PRODUCT_KEY "539333c2f84a402bbfb4fb2f6949f60e"
    /**@} */
    /**@name Product Secret
    * @{
    */
#define PRODUCT_SECRET "a690026c98754102a09c20a151dd4d0d"
...
#define RB_MAX_LEN          (MAX_PACKAGE_LEN*2)     ///< Maximum length of ring buffer
    ...
    * @{
    */
#define led0_BYTEOFFSET                    0
#define led0_BITOFFSET                     0
#define led0_LEN                           1

#define led1_RATIO                         1
#define led1_ADDITION                      0
#define led1_MIN                           0
#define led1_MAX                           100
    /**@} */
